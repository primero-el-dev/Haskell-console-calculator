...
/* package haskell-calculator-0.1.0.0 */
#ifndef VERSION_haskell_calculator
#define VERSION_haskell_calculator "0.1.0.0"
#endif /* VERSION_haskell_calculator */
#ifndef MIN_VERSION_haskell_calculator
#define MIN_VERSION_haskell_calculator(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_calculator */
...
#define CURRENT_COMPONENT_ID "haskell-calculator-0.1.0.0-1vk4Q2AvSCZ8yQP6BpFQ9B-haskell-calculator"
